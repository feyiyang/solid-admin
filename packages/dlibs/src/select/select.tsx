...
const Root: Component<KSelect.SelectRootProps<any>> = (props) => {
  ...
  return <KSelect.Root as='div' optionValue="value" optionTextValue="label" {...rest}>
...
const Option: Component<any> = (props) => {
  return <KSelect.Item class="select-item" item={props.item} {...props}>
    <KSelect.Label>{props.label}</KSelect.Label>
    <KSelect.ItemIndicator as="span" class="select__item-indicator inline-flex">
