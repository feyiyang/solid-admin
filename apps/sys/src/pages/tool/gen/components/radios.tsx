...
const RadioContain: Component<any> = () => {
  return (
    <div class="gap-4">
      ...
      <DRadioGroup.Root>
        <DRadioGroup.Radio name="rd0" value="1">
          选项
        </DRadioGroup.Radio>
        <DRadioGroup.Radio name="rd0" value="2">
          选项
        </DRadioGroup.Radio>
      </DRadioGroup.Root>
      ...
      <div class="grid grid-cols-4">
        <DRadioGroup.Root class="mr-8" defaultValue="1">
          ...
          <DRadioGroup.Radio name="rd1" value="1" disabled>
            选项
          </DRadioGroup.Radio>
          <DRadioGroup.Radio name="rd1" value="2">
            选项
          </DRadioGroup.Radio>
        </DRadioGroup.Root>
        <DRadioGroup.Root disabled>
          <span class="ml-16 mr-6">禁用组</span>
          <DRadioGroup.Radio name="rd2" value="1">
            选项
          </DRadioGroup.Radio>
          <DRadioGroup.Radio name="rd2" value="2">
            选项
          </DRadioGroup.Radio>
        </DRadioGroup.Root>
      </div>
